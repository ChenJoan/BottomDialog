...
import com.chenchong.R;
import com.chenchong.tools.BaseTools;
...
public class BottomView extends RelativeLayout {
	...
	private void init(Context context) {
		...
		BottomView.this.scrollTo(0, mScreenHeigh);
	...
	public void show(){
		if(!isShow && !isMoving){
			BottomView.this.startMoveAnim(-viewHeight,   viewHeight, mDuration);
			isShow = true;
			Log.d("isShow", "true");
			changed();
		}
	...
	public void dismiss(){
		if(isShow && !isMoving){
			BottomView.this.startMoveAnim(0, -viewHeight, mDuration);
			isShow = false;
			Log.d("isShow", "false");
			changed();
		}
